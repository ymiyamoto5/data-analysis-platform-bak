...
# Sensor
sensor_01 = Sensor(sensor_name="load01", sensor_type_id="load")
sensor_02 = Sensor(sensor_name="load02", sensor_type_id="load")
sensor_03 = Sensor(sensor_name="displacement", sensor_type_id="displacement")
sensor_04 = Sensor(sensor_name="load01", sensor_type_id="load")
sensor_05 = Sensor(sensor_name="displacement", sensor_type_id=2)
sensor_06 = Sensor(sensor_name="load01", sensor_type_id="load")
sensor_07 = Sensor(sensor_name="load02", sensor_type_id="load")
sensor_08 = Sensor(sensor_name="load03", sensor_type_id="load")
sensor_09 = Sensor(sensor_name="load04", sensor_type_id="load")
sensor_10 = Sensor(sensor_name="load05", sensor_type_id="load")
sensor_11 = Sensor(sensor_name="load06", sensor_type_id="load")
sensor_12 = Sensor(sensor_name="load07", sensor_type_id="load")
sensor_13 = Sensor(sensor_name="load08", sensor_type_id="load")
sensor_14 = Sensor(sensor_name="load09", sensor_type_id="load")
sensor_15 = Sensor(sensor_name="load10", sensor_type_id="load")
sensor_16 = Sensor(sensor_name="load11", sensor_type_id="load")
sensor_17 = Sensor(sensor_name="load12", sensor_type_id="load")
sensor_18 = Sensor(sensor_name="load13", sensor_type_id="load")
sensor_19 = Sensor(sensor_name="load14", sensor_type_id="load")
sensor_20 = Sensor(sensor_name="load15", sensor_type_id="load")
sensor_21 = Sensor(sensor_name="pulse", sensor_type_id="pulse")
sensor_22 = Sensor(sensor_name="load03", sensor_type_id="load")
sensor_23 = Sensor(sensor_name="load04", sensor_type_id="load")
