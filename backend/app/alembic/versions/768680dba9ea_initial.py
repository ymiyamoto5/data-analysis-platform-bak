...
def upgrade():
    ...
    op.create_table('data_collect_history_details',
    ...
    op.create_index(op.f('ix_data_collect_history_details_data_collect_history_id'), 'data_collect_history_details', ['data_collect_history_id'], unique=False)
    op.create_index(op.f('ix_data_collect_history_details_sensor_id'), 'data_collect_history_details', ['sensor_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_data_collect_history_details_sensor_id'), table_name='data_collect_history_details')
    op.drop_index(op.f('ix_data_collect_history_details_data_collect_history_id'), table_name='data_collect_history_details')
    op.drop_table('data_collect_history_details')
