...
api_router.include_router(
    machine_types.router, prefix="/machine_types", tags=["machine_types"]
)
...
api_router.include_router(
    sensor_types.router, prefix="/sensor_types", tags=["sensor_types"]
)
api_router.include_router(controller.router, prefix="/controller", tags=["controller"])
api_router.include_router(
    cut_out_shot.router, prefix="/cut_out_shot", tags=["cut_out_shot"]
)
api_router.include_router(
