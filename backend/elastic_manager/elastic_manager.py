...
ELASTIC_URL: Final[Optional[str]] = os.getenv("elastic_url")
ELASTIC_USER: Final[Optional[str]] = os.getenv("elastic_user")
ELASTIC_PASSWORD: Final[Optional[str]] = os.getenv("elastic_password")
