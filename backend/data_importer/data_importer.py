...
class DataImporter:
    ...
    def import_by_shot_pkl(self, target: str):
        ...
        setting_shots: str = os.getenv("setting_shots_path", "backend/mappings/setting_shots.json")
        ...
        setting_shots_meta: str = os.getenv("setting_shots_meta_path", "backend/mappings/setting_shots_meta.json")
