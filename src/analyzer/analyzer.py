...
class Analyzer:
    ...
    def apply(self, feature: str, func: Callable, sub_func: Callable = None,) -> None:
    ...
    def _multi_process(self, feature_index: str, feature: str, func: Callable, sub_func: Callable = None,) -> None:
        ...
        for shots_num in shots_num_by_proc:
            ...
            proc: multiprocessing.context.Process = multiprocessing.Process(
                ...
                args=(feature_index, start_shot_number, end_shot_number, feature, func, sub_func,),
            )
            proc.start()
            procs.append(proc)
...
if __name__ == "__main__":
    ...
    analyzer.apply(
        feature="max", func=ef.max_load, sub_func=None,
    )
    analyzer.apply(
        feature="start", func=ef.load_start3, sub_func=None,
    )
    analyzer.apply(
        feature="break", func=ef.breaking_vmin_amin, sub_func=ef.narrowing_v4min_mab,
    )
