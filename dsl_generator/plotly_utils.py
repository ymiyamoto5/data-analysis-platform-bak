...
def _plotly_add_shape(fig,ftype,xmin,xmax,ymin,ymax,fillcolor,alpha,xref,yref):
    """
...
def plotly_hspan(fig,ymin,ymax,ftype='rect',xref='x',yref='y',fillcolor='LightSalmon',alpha=0.5):
    """
    ...
    for d in fig.data:
        if d['xaxis'] == xref:
            ...
            xmax = d['x'].max()
            break
    _plotly_add_shape(fig,ftype,xmin,xmax,ymin,ymax,fillcolor,alpha,xref,yref)
    
def plotly_vspan(fig,xmin,xmax,ftype='rect',xref='x',yref='y',fillcolor='LightSalmon',alpha=0.5):
    """
